...
export const EditAcces2 = () => {
  const { showModal, modalName, openModal, closeModal } = useModal()

  if (!showModal || (showModal && modalName !== 'Acces2')) {
    return null
  }
      ...
      <MarginBox>
        ...
        <ModalCard maxWidth="55rem" maxHeight="40rem">
          ...
          >
            <Box flex col align="flex-start" gap="1.5rem">
              <Box flex col align="flex-start" gap="0.25rem">
                ...
                >
                  <Input placeholder="john.doe.workemail@company.com" rightIcon={<Icon icon="Close" size={15} />}></Input>
                </Box>
              </Box>
              <Box flex col align="flex-start" gap="0.25rem">
                <Text fontSize="1.2rem" weight={700} lineHeight="1.6rem" uppercase>
          ...
          >
            ...
            <ValidButton onClick={() => openModal('Acces3')}>Valider mes informations</ValidButton>
          </ButtonMargin>
        </ModalCard>
      </MarginBox>
    </BlurOverlay>
